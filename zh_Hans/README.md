...
__v4.10.0 @ 2026-09-14__
  ...
  - 媒体详情页：在顶部栏菜单中新增“从附近接收”选项。
  
---

__v4.9.0 @ 2026-09-10__
  
  - 在实况文本激活的情况下，临时禁用单指长按的加速播放手势。
...
__v4.6.0 @ 2026-08-23__
  ...
  - 支持使用自定义图片代替从视频帧自动生成的封面。
  - 更新水印编辑页面的相关导航（iPad 版）。
  
---

__v4.5.0 @ 2026-08-16__
  
  - 支持添加网络视频，包括公开的 YouTube 和 Bilibili 视频。
  
---

__v4.4.0 @ 2026-08-01__
  
  - 新增主列表左侧边缘轻扫手势，可唤出侧边栏菜单（iPhone、iPad 版）。
  
---

__v4.3.0 @ 2026-07-05__
  
  - 提升了双指进度条微调手势在极慢速下的精准度。
...
__v4.0.0 @ 2026-04-24__
  ...
  - 重构并优化了数据库存储和数据同步。
  - 数据同步历史详情页面：提供水印和媒体关系的相关信息。
  - 媒体详情页面：调整了 iPad 上笔记搜索的输入框位置。
  - 错误修复 - 媒体详情视图：在 iOS 17 上继续观看上一个媒体时，轻击播放器无法隐藏控制组件。
...
__v3.59.1 @ 2026-03-27__
  ...
  - 媒体详情页面：在全屏展示媒体时，支持捏合缩放手势。
  - Mac 版本快捷键：  
    * i. 按 Command (⌘) + =/- 进行缩放；按 Command (⌘) + 0 以重置。  
    * ii. 若要移动缩放后的媒体，按住 Command (⌘) 键的同时，在触控板上双指水平移动。
  
---

__v3.58.0 @ 2026-03-09__
  
  - 在媒体详情页面中新增针对单个条目的只读模式控制（基于 Premium 功能：只读模式）：
  - 临时可编辑：在开启应用范围只读模式下，可临时关闭当前页面的只读模式。
  - 锁定此媒体：将当前媒体设为只读，并禁止切换到其它媒体。
...
__v3.57.0 @ 2026-02-20__
  ...
  - 更新了媒体详情页面的工具栏布局。
  - 修复了播放速度手势操作与音量控件之间的冲突。
  
---

__v3.56.0 @ 2026-02-14__
  
  - 支持恢复播放功能：切换项目或退出应用后，可从上次中断的位置继续观看。
  - 更新了已标记/收藏条目列表中的“在媒体列表中显示”选项。
  
---

__v3.55.0 @ 2026-02-10__
  
  - 媒体列表：在工具栏中添加了“定位所选媒体”选项。
...
__v3.54.1 @ 2026-02-07__
  ...
  - 优化 iCloud 文件同步。
  - 更新播放速度手势操作：在播放器右侧，通过单指长按，可临时提高播放速度；按住时，通过垂直移动手指可进行微调。
  
---

__v3.53.0 @ 2026-01-23__
  
  - 改进了对已标签和已收藏条目列表的搜索功能。
  - 更新了标签列表分屏视图，以提高可读性（iPad、Mac 版）。
  
---

__v3.52.0 @ 2026-01-12__
  
  - 媒体列表搜索：支持限定词（title:、note:、tag:）以进行更精确的筛选。
  - 小提示：您可以在开头输入冒号（:）以显示可用限定词。
