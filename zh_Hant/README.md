...
__v4.10.0 @ 2026-09-14__
  ...
  - 媒體詳情頁：在頂部欄菜單中新增「從附近接收」選項。
  
---

__v4.9.0 @ 2026-09-10__
  
  - 在原況文字激活的情況下，臨時禁用單指長按的加速播放手勢。
...
__v4.6.0 @ 2026-08-23__
  ...
  - 支持使用自定義圖片代替從視頻幀自動生成的封面。
  - 更新水印編輯頁面的相關導航（iPad 版）。
  
---

__v4.5.0 @ 2026-08-16__
  
  - 支援新增網絡視頻，包括公開的 YouTube 和 Bilibili 視頻。
  
---

__v4.4.0 @ 2026-08-01__
  
  - 新增主清單左側邊緣輕掃手勢，可喚出側邊欄選單（iPhone、iPad 版）。
  
---

__v4.3.0 @ 2026-07-05__
  
  - 提升了雙指進度條微調手勢在極慢速下的精準度。
...
__v4.0.0 @ 2026-04-24__
  ...
  - 重構並優化了資料庫存儲與數據同步。
  - 數據同步歷史詳情頁面：提供水印與媒體關係的相關資訊。
  - 媒體詳情頁面：調整了 iPad 上筆記搜尋的輸入框位置。
  - 錯誤修復 - 媒體詳情視圖：在 iOS 17 上繼續觀看上一個媒體時，輕擊播放器無法隱藏控制組件。
...
__v3.59.1 @ 2026-03-27__
  ...
  - 媒體詳情頁面：在全螢幕檢視媒體時，新增雙指縮放支援。
  - Mac 版本快捷鍵：  
    * i. 按 Command (⌘) + =/- 進行縮放；按 Command (⌘) + 0 以重設。  
    * ii. 若要移動縮放後的媒體，按住 Command (⌘) 鍵的同時，在觸控板上雙指水平移動。
  
---

__v3.58.0 @ 2026-03-09__
  
  - 在媒體詳情頁面中新增針對單個條目的只讀模式控制（基於 Premium 功能：只讀模式）：
  - 臨時可編輯：在開啟程式範圍只讀模式下，可臨時關閉當前頁面的只讀模式。
  - 鎖定此媒體：將當前媒體設為只讀，並禁止切換到其它媒體。
...
__v3.57.0 @ 2026-02-20__
  ...
  - 更新了媒體詳情頁面的工具欄佈局。
  - 修復了播放速度手勢操作與音量控件之間的衝突。
  
---

__v3.56.0 @ 2026-02-14__
  
  - 支持恢復播放功能：切換項目或退出程式後，可從上次中斷的位置繼續觀看。
  - 更新了已標記/收藏條目列表中的「在媒體列表中顯示」選項。
  
---

__v3.55.0 @ 2026-02-10__
  
  - 媒體列表：在工具欄中添加了“定位所選媒體”選項。
...
__v3.54.1 @ 2026-02-07__
  ...
  - 優化 iCloud 文件同步。
  - 更新播放速度手勢操作：在播放器右側，通過單指長按，可臨時提高播放速度；按住時，通過垂直移動手指可進行微調。
  
---

__v3.53.0 @ 2026-01-23__
  
  - 改進了對已標籤和已收藏條目列表的搜索功能。
  - 更新了標籤列表分屏視圖，以提高可讀性（iPad、Mac 版）。
  
---

__v3.52.0 @ 2026-01-12__
  
  - 媒體列表搜索：支持限定詞（title:、note:、tag:）以進行更精確的篩選。
  - 小提示：您可以在開頭輸入冒號（:）以顯示可用限定詞。
...
__v3.49.0 @ 2025-12-21__
  ...
  - 媒體播放器：支持從暫停幀中提取文本（原況文字）。
  * 對於 iOS 设备，需搭載 A12 仿生芯片或更高版本。
